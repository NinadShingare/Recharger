					...
					<div class="col-md-8 d-flex flex-row-reverse" style="height: 2.4rem;">
						...
						<form action="searchPlan" method="GET" role="search" 
							...
							<div class="d-flex">
								...
								<button class="btn btn-outline-danger mb-3 mx-2" type="button" 
									id="search-select-open" hidden="hidden"
									data-bs-toggle="tooltip" title="Select & Delete multiple Plans">
									Delete Multiple Plans
								</button>
						...
						<form action="searchPlan" method="GET" role="search" 
							...
							<div class="d-flex">
								...
								<button class="btn btn-outline-danger mb-3 mx-2" type="button" 
									id="search-num-select-open" hidden="hidden"
									data-bs-toggle="tooltip" title="Select & Delete multiple Plans">
									Delete Multiple Plans
								</button>
			...
			<div class="card shadow mb-3 rounded" style="border: 1px solid black;"
				...
				<div class="card-body">
					...
					<button data-bs-toggle="modal"
						...
						class="btn btn-dark mx-4" data-bs-toggle="tooltip" title="Select this plan">
						Select
					</button>

					<button data-bs-toggle="modal"
						data-bs-target="#deleteModal<%=plan.getId()%>" data-bs-toggle="tooltip"
						class="btn btn-outline-danger" hidden="hidden" title="Delete this plan">
						Delete
					</button>
				</div>
			</div>
		...
		<div class="modal fade centered" id="updateModal<%=plan.getId()%>"
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<form action="/select" method="POST" class="needs-validation" novalidate>
						<div class="modal-body">
								...
								<div class="col">
									<div class="form-group">
										<label for="recipient-name" class="col-form-label">
											<b>ID</b></label>
										<input type="Number" disabled value="<%=plan.getId()%>" name="id"
							...
							<div class="row">
								...
								<div class="col">
									<div class="form-group">
										...
										<b style="color: red;"> *</b></label>
										<div class="input-group">
											<input type="number" disabled class="form-control" name="validity"
							...
							<div class="form-group">
								...
								<input class="form-control" disabled id="message-text" name="description"
