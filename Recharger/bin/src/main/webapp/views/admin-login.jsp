...
<head>
	...
	<title>Mobile Plan: Admin Login</title>
...
<body>
	...
	<%-- Admin Login Card --%>
	<div class="card shadow p-3 my-4 bg-body rounded" id="admin-login-card">
		<div class="card-body">
			<div class="row" id="admin-login-card-row">
				<div class="col-md-6 p-4">
					<h1>
						<b>Admin Login</b>
                    </h1>
					<br>
					<form action="/adminVerify" method="POST" class="needs-validation" novalidate>
						...
						<div class="row">
							...
							<div class="col-md-7">
								<a class="btn btn-outline-dark mt-4" href="/home">
									Go back to Mobile Plan</a>
							</div>
						</div>
                    </form>
				</div>
